...
export class VerifiedComponent implements OnInit, OnDestroy {
  ...
  columnDefs: ColDef[] = [
    ...
    { headerName: 'Location Code', field: 'location_Code', width: 110 },
    {
      ...
      tooltipField: 'vendor_name_english',
      tooltipComponentParams: {
        color: '#1D598E'
      }
    },
    { headerName: 'Modified Date EST (mm/dd/yyyy)', field: 'modifiedDT', width: 110 },
    { headerName: 'Modified User Id', field: 'modifiedBy', width: 110 },
    { headerName: 'Bill Total Amount (Local)', field: 'invoiceAmt', width: 110 },
...
//
  ...
  loadData(filters: BillsTParams): void {
    ...
    filters.InvoiceStatus = 'Verified'; 
    this.billsSubscription = this.billsService.getBillsReport(filters).subscribe({
      ...
      error: (error) => {
        console.error('Error loading Verified Bills:', error);
