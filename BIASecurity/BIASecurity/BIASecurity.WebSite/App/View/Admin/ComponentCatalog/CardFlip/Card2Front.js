Ext.define('App.View.Admin.ComponentCatalog.CardFlip.Card2Front', {
    extend: 'Ext.container.Container',
    alias: 'widget.App-View-Admin-ComponentCatalog-CardFlip-Card2Front',
    flex: 1,
    ...
    items: [
        {
            ...
            items: [
                { xtype: 'tbfill', flex: 1 },
                { xtype: 'container', html: 'User Summary' },
                { xtype: 'tbfill', flex: 1 }
            ]
        },
        {
            ...
            items: [
                { xtype: 'textfield', value: 'New', fieldLabel: 'First Name', disabled: true, columnWidth: .4 },
                { xtype: 'textfield', value: 'U', fieldLabel: 'Middle Initial', disabled: true,columnWidth: .2 },
                { xtype: 'textfield', value: 'Employee', fieldLabel: 'Last Name', disabled: true, columnWidth: .4 },
