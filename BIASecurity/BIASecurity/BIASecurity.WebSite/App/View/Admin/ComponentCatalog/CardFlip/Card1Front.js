Ext.define('App.View.Admin.ComponentCatalog.CardFlip.Card1Front', {
    extend: 'Ext.container.Container',
    alias: 'widget.App-View-Admin-ComponentCatalog-CardFlip-Card1Front',
    layout: {
        type: 'hbox',
        align: 'stretch',
        pack: 'start'
    ...
    items: [
        ...
        {
            xtype: 'container',
            html: '<img src="images/pickle.png" height="250px" width="222px" />'
        }        
    ]
});