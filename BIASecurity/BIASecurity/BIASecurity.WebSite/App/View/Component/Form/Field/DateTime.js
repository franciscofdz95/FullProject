...
Ext.define('App.View.Component.Form.Field.DateTime', {
 /*
 ...
 */
    ...
    alias: 'widget.App-View-Component-Form-Field-DateTime',
    xtype: 'datetimefield',
    requires: ['App.View.Component.Picker.DateTime'],
    ...
    collapseIf: function collapseIf(e) {
        var me = this,
            picker = me.picker;
    ...
    createPicker: function createPicker() {
        ...
        return Ext.create('App.View.Component.Picker.DateTime', Ext.merge(initialConfig, parentConfig));
    },
    ...
    getRefItems: function getRefItems() {
        var me = this,
