Ext.define('App.View.Component.Picker.DateTime', {
/*
 ...
 */
    ...
    alias: 'widget.App-View-Component-Picker-DateTime',
    ...
    initComponent: function initComponent() {
        ...
        me.hourSlider = new Ext.slider.Single({
            ...
            maxValue: 23,
            vertical: true,
            tipText: function tipText(thumb) {
    ...
    changeTimeValue: function changeTimeValue(slider, e, eOpts) {
        var me = this,
    ...
    afterShow: function afterShow(animateTarget, callback, scope) {
        var me = this,
    ...
    afterSetPosition: function afterSetPosition(x, y) {
        this.callParent([x, y]);
        this.alignTimePicker();
    },

    alignTimePicker: function alignTimePicker() {
        var me = this,
            el = me.el,
    ...
    getTimePickerSide: function getTimePickerSide() {
        var el = this.el,
            body = Ext.getBody(),
    ...
    handleDateClick: function handleDateClick(e, t, /*private*/ blockStopEvent) {
        var me = this,
            handler = me.handler,
    ...
    selectedUpdate: function selectedUpdate(date) {
        var me = this,
    ...
    fullUpdate: function fullUpdate(date) {
        var me = this,
            dateOnly = Ext.Date.clearTime(date, true);
    ...
    updateSliders: function updateSliders() {
        ...
        if (!Ext.isDate(currentDate)) currentDate = new Date(currentDate);

        if (me.timePicker.rendered && Ext.isDate(currentDate)) {
