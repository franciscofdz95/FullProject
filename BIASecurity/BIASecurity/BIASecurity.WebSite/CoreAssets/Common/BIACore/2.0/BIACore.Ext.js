...
/* \0Ext\chart\legend\SpriteLegend.js */
(function () {
...
//    }
//}());
/* \0Ext\data\operation\Operation.js */
(function () {
    if (Ext.getVersion().major < 5) {
...
(function () {
    ...
    var version = Ext.getVersion() || {};
    if (version.major > 4 && Ext.platformTags &&  Ext.platformTags.classic) {
            ...
            defaultRenderer: function (v, meta, record, rowIdx, colIdx, store, view) {
                ...
                for (; i < len; i++) {
                    ...
                    if (glyph) {
                        ...
                        ret += '<span role="button" title="' + (item.altText || me.altText) + '" class="' + prefix + 'action-col-icon ' + prefix + 'action-col-' + String(i) + ' ' + (disabled ? prefix + 'item-disabled' : ' ') +
                            (Ext.isFunction(item.getClass) ? item.getClass.apply(item.scope || scope, arguments) : '') + '"' +
                            (tooltip ? ' data-qtip="' + tooltip + '"' : '') + '>' +
                            '<i class="fa ' + (fontAwesomeIcon || item.iconCls || me.iconCls || '') + ' ' + prefix + 'action-col-' + String(i) + '"></i>' + '</span>';
                    }
                    else {
...
/* \0Ext\grid\plugin\RowEditing.js */
(function () {
    if (Ext.getVersion().major >= 6) {
...
/* \0Ext\layout\container\Column.js */
//(function () {
//    if (Ext.getVersion().major >= 5) {
...
//    }
//}());
/* \0Ext\layout\container\Container.js */
(function () {
...
/* \0Ext\tip\ToolTip.js */
// change the default tooltip hover from 5 to 10 seconds.
Ext.override(Ext.tip.ToolTip, {
    dismissDelay: 10000
});
/* \0Ext\toolbar\Paging.js */
(function () {
...
Ext.define('Ext.ux.BoxReorderer', {
    ...
    afterBoxReflow: function () {
        var me = this;
        if (me.dragCmp.el) {// might have been deleted
    ...
    getNewIndex: function () {
        var me = this,
            dragEl = me.getDragEl(),
            dragBox = Ext.get(dragEl).getBox(), //Ext.fly(dragEl).getBox(),
            targetEl,
            targetBox,
            targetMidpoint,
            i = 0,
        ...
        for (; i < ln; i++) {
            ...
            if (targetEl.is(me.reorderer.itemSelector)) {
                ...
                targetMidpoint = targetBox[me.startAttr] + (targetBox[me.dim] >> 1); // fast integer divide by 2.
                if (i < me.curIndex) {
...
/* \0Ext\ux\exporter\csvFormatter\CsvFormatter.js */
/**
...
Ext.define("Ext.ux.exporter.csvFormatter.CsvFormatter", {
    ...
    getHeaders: function (store) {
        ...
        Ext.each(this.columns, function (col) {
            var title;
            if (!col.getXType || col.getXType() != "rownumberer") {
    ...
    getCell: function (record, index) {
        ...
        Ext.each(this.columns, function (col) {
            ...
            if (name && (!col.getXType || col.getXType() != "rownumberer")) {
...
/* \0Ext\ux\exporter\excelFormatter\Cell.js */
/**
...
/* \0Ext\ux\exporter\excelFormatter\ExcelFormatter.js */
/**
...
/* \0Ext\ux\exporter\excelFormatter\Style.js */
/**
...
/* \0Ext\ux\exporter\excelFormatter\Workbook.js */
/**
...
Ext.define("Ext.ux.exporter.excelFormatter.Workbook", {
    ...
    constructor: function (config) {
        ...
        Ext.apply(this, config, {
             ...
             */
            hasStripeStyles: false,

            /**
             * @property wrapColumnHeaders
             * @type Boolean
             * True to configure column header styling to wrap text for auto-fit to fit to size of data and not header text
             */
    ...
    addWorksheet: function (store, config) {
        var worksheet = new Ext.ux.exporter.excelFormatter.Worksheet(store, Ext.apply({ wrapColumnHeaders: this.wrapColumnHeaders }, config));
    ...
    addStyle: function (config) {
        ...
        if(Ext.Array.pluck(this.styles,'id').indexOf(style.id) < 0) this.styles.push(style);
            ...
            attributes: [
              ...
              },
              {
                  ...
                  properties: [
                    ...
                    { name: "Color", value: "LightGray" }
                  ]
              },
              {
                  name: "Alignment",
                  properties: [
                    { name: "WrapText", value: this.wrapColumnHeaders === false ? "0" : "1" },
                    { name: "Horizontal", value: "Center" }
                  ]
              }
            ]
    ...
    addFilterDisplayStyle: function () {
        this.addStyle({
            id: "filterdisplaycell",
            attributes: [
              {
                  name: "Font",
                  properties: [
    ...
    addStripedStyles: function () {
        ...
        Ext.each(['even', 'odd'], function (parentStyle) {
            ...
            this.addChildNumberFormatStyle(parentStyle, parentStyle + 'datetime', "[ENG][$-409]dd\-mmm\-yyyy;@");
            ...
            this.addChildNumberFormatStyle(parentStyle, parentStyle + 'percent', "Percent");
            this.addChildNumberFormatStyle(parentStyle, parentStyle + 'currency', "&quot;$&quot;#,##0.00");
        }, this);
    },
    ...
    addBasicStyles: function () {
        this.addStyle({
            ...
            attributes: [
              {
                  name: "NumberFormat",
                  properties: [{ name: "Format", value: 'Percent' }]
              }
            ]
        });
        ...
        this.addStyle({
            ...
            attributes: [
              {
                  name: "NumberFormat",
                  properties: [{ name: "Format", value: '&quot;$&quot;#,##0.00' }]
              }
            ]
        });
    },
     ...
     *
     */
    addMissingStyles: function () {
        var columnStyles = Ext.Array.clean(Ext.Array.unique(Ext.Array.pluck(this.columns, 'exportStyle')));
        for (var i = 0; i < columnStyles.length; i++) {
            if (!Ext.Array.findBy(this.styles,function (s) { return s.id == columnStyles[i]; })) {
                this.addStyle({
                    id: columnStyles[i],
                    attributes: [
                        { name: "Font" }
...
/* \0Ext\ux\exporter\excelFormatter\Worksheet.js */
/**
...
BIA.application = function (config) {
    ...
    BIACore.onReady(function () {
        ...
        if (Ext.getVersion().major >= 5) {
            BIACore.Loader.css((BIACore.isLocalHost() && BIACore.Config.appCode === "BIACore" ? '/' : '/CoreAssets/common/biacore/2.0/') + 'css/Ext5/Fixes.css');
        }

        if (Ext.getVersion().major >= 7) {
            BIACore.Loader.css((BIACore.isLocalHost() && BIACore.Config.appCode === "BIACore" ? '/' : '/CoreAssets/common/biacore/2.0/') + 'css/Ext7/Fixes.css');
        }
...
/* \BIA\Components\ClickConfirmationPopup.js */
...
/* \BIA\Components\FingerprintValue.js */
...
/* \BIA\Components\HeaderContainer.js */
if (Ext.getVersion().major >= 5) {
...
//#endregion
/* \BIA\Components\CardFlip\Container.js */
...
/* \BIA\Components\CardFlip\Side.js */
...
/* \BIA\Components\CardFlip\Side\Container.js */
...
/* \BIA\Components\CardFlip\Side\FlipButton\Footer.js */
...
/* \BIA\Components\CardFlip\Side\FlipButton\LeftEdge.js */
Ext.define('BIA.Components.CardFlip.Side.FlipButton.LeftEdge', {
    extend: (Ext.platformTags && Ext.platformTags.modern) ? 'Ext.Container' : 'Ext.container.Container',
    alias: 'widget.BIA-Components-CardFlip-Side-FlipButton-LeftEdge'
});
/* \BIA\Components\CardFlip\Side\FlipButton\RightEdge.js */

/* \BIA\Components\Chart\StatusPie.js */
...
/* \BIA\Components\Export\SpreadsheetInterface.js */
...
/* \BIA\Components\Export\Spreadsheet\ButtonContainer.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptButton.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptWindow.js */
...
/* \BIA\Components\Export\Spreadsheet\QuickCSVButton.js */
...
/* \BIA\Components\Export\Spreadsheet\QuickExcelButton.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptWindow\Exports.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptWindow\Message.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptWindow\Options.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptWindow\Title.js */
Ext.define('BIA.Components.Export.Spreadsheet.PromptWindow.Title', {
    extend: (Ext.platformTags && Ext.platformTags.modern) ? 'Ext.Container' : 'Ext.container.Container',
    alias: 'widget.BIA-Components-Export-Spreadsheet-PromptWindow-Title',
    xtype: 'exportSpreadsheetPromptWindowTitle'

});
/* \BIA\Components\Export\Spreadsheet\PromptWindow\Exports\All.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptWindow\Exports\Formatted.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptWindow\Options\ExportAll.js */
...
/* \BIA\Components\Export\Spreadsheet\PromptWindow\Options\ExportCSV.js */
...
/* \BIA\Components\Export\Window\Loading.cnt.js */
...
/* \BIA\Components\Export\Window\Main.js */
...
/* \BIA\Components\Export\Window\Component\MessageContainer.js */
...
/* \BIA\Components\Export\Window\IEComplete\Container.js */
...
/* \BIA\Components\Export\Window\IEComplete\Icon.js */
...
/* \BIA\Components\Export\Window\IEComplete\Message.js */
...
/* \BIA\Components\Export\Window\Loading\Autoclose.js */
...
/* \BIA\Components\Export\Window\Loading\Container.js */
...
/* \BIA\Components\Export\Window\Loading\Icon.js */
...
/* \BIA\Components\Export\Window\Loading\Message.js */
...
/* \BIA\Components\FusionCharts\AngularGauge.js */
...
/* \BIA\Components\PagedList\Item.js */
...
/* \BIA\Components\PagedList\PagingToolbar.js */
...
//#endregion
/* \BIA\Components\PagedList\PagingToolbar\Button.js */
...
//#endregion
/* \BIA\Components\PagedList\PagingToolbar\GoToPage.js */
...
/* \BIA\Components\PagedList\PagingToolbar\Refresh.js */
...
/* \BIA\container\FilterContainer.js */
/**
...
/* \BIA\container\FilterContainerCard.js */
/**
...
/* \BIA\controller\CardFlip.cnt.js */
...
/* \BIA\controller\ClickConfirmationPopup.cnt.js */
...
/* \BIA\controller\ExportSpreadsheetButtonContainer.cnt.js */
...
/* \BIA\controller\ExportSpreadsheetPromptWindow.cnt.js */
...
/* \BIA\controller\FilterContainer.cnt.js */
(function () {
...
/* \BIA\controller\GlobalEvents.cnt.js */
(function () {
    if (Ext.getVersion().major >= 4) {
...
groupchange
*/
/* \BIA\controller\HoverWindow.cnt.js */
...
/* \BIA\controller\PagedList.cnt.js */
//#region Controller
...
//#endregion
/* \BIA\controller\PageViewImpression.cnt.js */
...
/* \BIA\controller\PerformanceTrackerDetail.cnt.js */
...
/* \BIA\controller\PerformanceTrackerInterface.cnt.js */
...
/* \BIA\controller\PerformanceTrackerSummary.cnt.js */
...
/* \BIA\controller\Chart\StatusPie.cnt.js */
...
/* \BIA\controller\FusionCharts\AngularGauge.cnt.js */
...
/* \BIA\controller\PagedList\Item.cnt.js */
Ext.define('BIA.Controller.Components.List.Item', {
    extend: 'Ext.app.Controller',

    init: function init() {
        this.control({
            'BIA-Components-PagedList-Item': {
            ...
            'BIA-Components-PagedList-Item[header=true] [showOnHeader=true],BIA-Components-PagedList-Item [showOnHeader=false]': {
                beforerender: this.ListItemShowOnHeaderBeforeRender
            },
            'BIA-Components-PagedList-Item[header=true] [sort=true][dataField], BIA-Components-PagedList-Item[header=true] [sort=true][sortOn]': {
    ...
    ListItemHeaderSortClick: function ListItemHeaderSortClick(me, sortField, oldSortDir, newSortDir, event) {
        var pagedlist = me.up('pagedlist'),
            listItemHeader = me.up('BIA-Components-PagedList-Item[header=true]');
...
/* \BIA\controller\Plugin\ClickConfirmation.cnt.js */
Ext.define('BIA.Controller.ClearConfirmationPopup', {
    extend: 'Ext.app.Controller',
    init: function init() {
        this.listen({
...
/* \BIA\controller\Plugin\ComponentStoreBind.cnt.js */
...
/* \BIA\form\field\ClearableComboBox.js */
/**
...
/* \BIA\form\field\ClearableNumber.js */
...
/* \BIA\form\field\ClearableTextBox.js */
/**
...
/* \BIA\form\field\ClickableDisplayField.js */
...
/* \BIA\form\field\FormattedNumber.js */
if (Ext.platformTags && Ext.platformTags.modern) {
...
/* \BIA\form\field\MultiComboBox.js */
(function () {
    if (Ext.getVersion().major >= 5) {
        /**
...
/* \BIA\grid\feature\RemoteSummary.js */
/**
...
/* \BIA\grid\plugin\FormEditing.js */
...
/* \BIA\header\tool\PerformanceTrackerInterface.js */
Ext.define('BIA.header.tool.PerformanceTrackerInterface', {
    ...
    var NoPerformanceAnalysisMsg = 'Could not determine performance issue analysis because no tracking data was returned by Web API. This could be due to debug=false in the BIA section web.config or an un-managed ajax call.';
    ...
    */
    ...
    var analyzeRequestPartsTimePercent = Ext.bind(function analyzeRequestPartsTimePercent(debugData, percent) {
        ...
        var biaWebAPIAnalysisDescription = 'BIAWebAPI: BIACore\'s processing of the database request took longer than expected. If this problem persists, inform Matthew Erdmann or John Schuhr.';
        ...
        if (matchingPerformanceRecords.length > 0) {
            ...
            var addAnalysisData = function (item, id) {
                ...
                if (item.ProblemArea && Ext.isArray(item.ProblemArea) && Ext.Array.findBy(item.ProblemArea, function (pa) { return pa.Type == 'MultiCall'; }) == null) {
                    updateDebugDataStatusProblemLevel(item, 1, 2);
    ...
    var generateCallFormatAnalysis = Ext.bind(function generateCallFormatAnalysis(debugData) {
        if (debugData.WebAPIRoute == RouteURLErrorMsg) {
            ...
            debugData.AnalysisDescription.push('NoRoute: Could not determine the url for the call. This could be due to a mis-configuration of the call, using non-managed Ajax calls OR debug=false in the BIA part of web.config.');
        }
    }, me);
    ...
    var applyAjaxPerformanceAnalysis = Ext.bind(function applyAjaxPerformanceAnalysis(debugData, successful, response) {
        ...
        if (debugData.Status == 0 && debugData.AnalysisDescription.length == 0) {
            if (debugData.TransactionId != null) debugData.AnalysisDescription.push('No problem areas found with this request');
            else debugData.AnalysisDescription.push('Could not determine performance issue anlysis because no ajax tracking data was present in the response. This can be caused by un-managed Ajax calls OR debug=false in the BIA section web.config will prevent tracking response data.');
        }
    }, me);
...
/* \BIA\header\tool\PerformanceTrackerSummaryLogging.js */
...
//    StartLoggingTimer();
//});
/* \BIA\header\tool\PerformanceTracker\Detail.js */
...
/* \BIA\header\tool\PerformanceTracker\Sparkline.js */
(function () {
...
/* \BIA\header\tool\PerformanceTracker\Summary.js */
...
/* \BIA\header\tool\PerformanceTracker\Component\Grid.js */
...
/* \BIA\header\tool\PerformanceTracker\Component\GridSummary.js */
...
/* \BIA\header\tool\PerformanceTracker\Detail\Container.js */
...
/* \BIA\header\tool\PerformanceTracker\Detail\Timeline.js */
...
/* \BIA\header\tool\PerformanceTracker\Detail\Title.js */
...
/* \BIA\header\tool\PerformanceTracker\Detail\Component\InfoDisplay.js */
...
/* \BIA\header\tool\PerformanceTracker\Detail\Component\TimelinePart.js */
...
/* \BIA\header\tool\PerformanceTracker\Summary\CallGroups.js */

/* \BIA\header\tool\PerformanceTracker\Summary\ClearSessionButton.js */
...
/* \BIA\header\tool\PerformanceTracker\Summary\DataRefreshButton.js */
...
/* \BIA\header\tool\PerformanceTracker\Summary\LatestCalls.js */
...
/* \BIA\header\tool\PerformanceTracker\Summary\NewSessionButton.js */
...
/* \BIA\header\tool\PerformanceTracker\Summary\ProblemCalls.js */
Ext.create('Ext.data.Store', {
...
/* \BIA\header\tool\PerformanceTracker\Summary\Tabs.js */
...
/* \BIA\header\tool\PerformanceTracker\Summary\Utility.js */
Ext.define('BIA.header.tool.PerformanceTracker.Summary.Utility', {
    singleton: true,

    renderProblemAreaIcons: function renderProblemAreaIcons(value, metaData, record, rowIndex, colIndex, store, view) {
        return value;
    }
});
/* \BIA\panel\Carousel.js */
...
/* \BIA\plugin\ClickConfirmation.js */
if (Ext.getVersion().major >= 5) {
...
/* \BIA\plugin\ComponentStoreBind.js */
if (Ext.getVersion().major >= 5) {
...
/* \MyReports\controller\Filter\Date.js */
...
/* \MyReports\controller\Filter\Status.js */
...
/* \MyReports\controller\Filter\ToggleAgent.js */
...
/* \MyReports\controller\Filter\Type.js */
...
/* \MyReports\controller\Filter\User.js */
...
/* \MyReports\controller\Report\Grid.js */
...
/* \MyReports\store\Filter\Date.js */
...
/* \MyReports\store\Filter\Status.js */
...
/* \MyReports\store\Filter\Type.js */
...
/* \MyReports\store\Report\Grid.js */
