/* ====================================================================================================
NAME:			[Bills Verified Controller]
BEHAVIOR:		Bills Verified Events & Actions.
...
02/10/2017        Sudhir Dandale		 Created.
 ======================================================================================================*/
Ext.define('App.Controller.Bills.Verified', {
    extend: 'Ext.app.Controller',
    init: function () {
        this.control({
            'App-View-Bills-Verified-Report': {
                activate: this.VerifiedTabActivate
            }
        });
    },
    VerifiedTabActivate: function VerifiedTabActivate(tab) {
