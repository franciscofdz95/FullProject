/* ====================================================================================================
NAME:			[Bills Approved Controller]
BEHAVIOR:		Bills Approved Events & Actions.
...
02/10/2017        Sudhir Dandale		 Created.
 ======================================================================================================*/
Ext.define('App.Controller.Bills.Approved', {
    extend: 'Ext.app.Controller',
    init: function () {
        this.control({
            'App-View-Bills-Approved-Report': {
                activate: this.ApprovedTabActivate
            }
        });
    },
    ApprovedTabActivate: function ApprovedTabActivate(tab) {
