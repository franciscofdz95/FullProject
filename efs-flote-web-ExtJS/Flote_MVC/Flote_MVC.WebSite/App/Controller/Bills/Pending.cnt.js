/* ====================================================================================================
NAME:			[Bills Pending Controller]
BEHAVIOR:		Bills Pending Events & Actions.
...
02/10/2017        Sudhir Dandale		 Created.
 ======================================================================================================*/
Ext.define('App.Controller.Bills.Pending', {
    extend: 'Ext.app.Controller',
    init: function () {
        this.control({
            'App-View-Bills-Pending-Report': {
                activate: this.PendingTabActivate
            }
        });
    },
    PendingTabActivate: function PendingTabActivate(tab) {
